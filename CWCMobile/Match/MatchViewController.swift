...
//  Match App
//
//  Created by David Ruvinskiy on 6/1/18.
...
class MatchViewController: SwipingAppController, UICollectionViewDelegate, UICollectionViewDataSource, Floatable {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        sendFloatingViewUp(numberToSubtractFrom: -110)
    }
